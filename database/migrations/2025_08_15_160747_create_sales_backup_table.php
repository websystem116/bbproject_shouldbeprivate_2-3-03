...
class CreateSalesBackupTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sales_backup', function (Blueprint $table) {
            ...
            $table->string('tax')->nullable()->comment('消費税');
            $table->string('sales_sum')->nullable()->comment('売上合計');
