...
class CreateStudentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('students', function (Blueprint $table) {
            ...
            $table->integer('parent_user_id')->nullable()->comment('親御様ID');
            $table->string('password')->nullable()->comment('入退室システムユーザー登録用パスワード');
            $table->string('initial_password')->nullable()->comment('初期パスワード平文');
            $table->rememberToken()->comment('ログイン状態維持トークン');
