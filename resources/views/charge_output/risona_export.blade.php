...
$(function() {
    ...
    $(".monthPick").datepicker({
        ...
        minViewMode: 1,
        maxViewMode: 2,
        startDate: "{{ $tightening_date['min'] }}",
        endDate: "{{ $tightening_date['max'] }}",
    });
});
</script>
@endpush
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">非常勤給与一覧出力</div>
                <div class="panel-body">
                    <div class="form-group row">
                        {{ Form::open(['route' => ['salary_output.export_salary_list'], 'method' => 'POST', 'class' => 'form-horizontal']) }}
                    ...
                    <div class="form-group row">
                        <div class="col-md-2 ">
                            {{ Form::submit('非常勤給与一覧出力', ['class' => 'btn btn-primary', 'onfocus' => 'this.blur();']) }}
                        </div>
                    </div>
                    <br />
                    <br />
