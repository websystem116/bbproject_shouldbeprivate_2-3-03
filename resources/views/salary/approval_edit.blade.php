            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ $before_url }}" title="Back">
                            <button class="btn btn-warning btn-xs">戻る</button>
                        </a>

                        <br />
                        <br />
                        {{ Form::model($users, ['route' => ['salary.approval_edit', $users->id, $date], 'method' => 'GET', 'class' => 'form-horizontal']) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 offset-md-4 disp-value">
                        ...
                        @endif
                        {{ Form::model($users, ['route' => ['salary.approval_update', $users->id], 'method' => 'PUT', 'class' => 'form-horizontal']) }}
                        <div class="form-group">
                        </div>
                        {{ csrf_field() }}
                                ...
                                <tbody class='performance_tr'>
                                    @if ($daily_salaries->count() == 0)
                                        ...
                                        <tr class='performance_row'>
                                            <td>
                                                {{ Form::checkbox('apploval_flg[]', '0', false, ['class' => 'form-control checkbox_size custom-control-input apploval_flg', $disable]) }}
                                            </td>
                                            <td>
                                    ...
                                    @else
                                        ...
                                        @foreach ($daily_salaries as $index => $value)
                                            ...
                                            @endif
                                            <td>
                                                {{ Form::checkbox('apploval_flg[]', $index, $value->superior_approval, ['class' => 'form-control checkbox_size custom-control-input apploval_flg', $disable]) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::number('working_time[]', $value->working_time, ['class' => 'form-control  working_time', $readonly]) }}

                                            </td>
                                            <td>
                                                {{ Form::textarea('remarks[]', $value->remarks ?? '', ['class' => 'form-control remarks', 'placeholder' => '備考', 'rows' => '1', $readonly]) }}
                                            </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                ...
                                <tbody class='tranceportation_tr'>
                                    @if ($transportation_expenses->count() == 0)
                                        ...
                                        <tr class='tranceportation_row'>
                                            <td>
                                                {{ Form::checkbox('tranceportation_apploval_flg[]', '0', false, ['class' => 'form-control checkbox_size custom-control-input tranceportation_apploval_flg', $disable]) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::text('tranceportation_route[]', null, ['class' => 'form-control form_text tranceportation_route', $readonly]) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_boarding_station[]', null, ['class' => 'form-control  form_text tranceportation_boarding_station', $readonly]) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_get_off_station[]', null, ['class' => 'form-control  form_text tranceportation_get_off_station', $readonly]) }}
                                            </td>
                                            <td>
                                                {{ Form::number('tranceportation_unit_price[]', null, ['class' => 'form-control form_price  tranceportation_unit_price', 'max' => '100000', 'min' => '0', $readonly]) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::number('tranceportation_fare[]', null, ['class' => 'form-control form_price  tranceportation_fare', 'readonly']) }}
                                            </td>
                                            <td>
                                                {{ Form::textarea('tranceportation_remarks[]', null, ['class' => 'form-control  form_text tranceportation_remarks', 'placeholder' => '備考', 'rows' => '1', $readonly]) }}
                                            </td>
                                        </tr>
                                    @else
                                        ...
                                        @foreach ($transportation_expenses as $index => $value)
                                            ...
                                            @endif
                                            <td>
                                                {{ Form::checkbox('tranceportation_apploval_flg[]', $index, $value->superior_approval, ['class' => 'form-control checkbox_size custom-control-input tranceportation_apploval_flg', $disable]) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::text('tranceportation_route[]', $value->route, ['class' => 'form-control form_text tranceportation_route', $readonly]) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_boarding_station[]', $value->boarding_station, ['class' => 'form-control  form_text tranceportation_boarding_station', $readonly]) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_get_off_station[]', $value->get_off_station, ['class' => 'form-control  form_text tranceportation_get_off_station', $readonly]) }}
                                            </td>
                                            <td>
                                                {{ Form::number('tranceportation_unit_price[]', $value->unit_price, ['class' => 'form-control form_price  tranceportation_unit_price', 'max' => '100000', 'min' => '0', $readonly]) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::number('tranceportation_fare[]', $value->fare, ['class' => 'form-control form_price  tranceportation_fare', 'readonly']) }}
                                            </td>
                                            <td>
                                                {{ Form::textarea('tranceportation_remarks[]', $value->remarks ?? '', ['class' => 'form-control  form_text tranceportation_remarks', 'placeholder' => '備考', 'rows' => '1', $readonly]) }}
                                            </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                ...
                                <tbody>
                                    @if ($daily_other_salaries->count() == 0)
                                        ...
                                        <tr class='other_performance_row'>
                                            <td>
                                                {{ Form::checkbox('other_apploval_flg[]', '0', false, ['class' => 'form-control checkbox_size  custom-control-input other_apploval_flg', 'id' => 'select_flg', $disable]) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::textarea('other_remarks[]', null, ['class' => 'form-control ', 'id' => 'remarks', 'placeholder' => '備考', 'rows' => '1', $readonly]) }}
                                            </td>
                                        </tr>
                                    @else
                                        ...
                                        @foreach ($daily_other_salaries as $index => $value)
                                            ...
                                            @endif
                                            <td>
                                                {{ Form::checkbox('other_apploval_flg[]', $index, $value->superior_approval, ['class' => 'form-control checkbox_size  custom-control-input other_apploval_flg', $disable, 'id' => 'select_flg']) }}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {{ Form::textarea('other_remarks[]', $value->remarks ?? '', ['class' => 'form-control ', 'id' => 'remarks', 'placeholder' => '備考', 'rows' => '1', $readonly]) }}
                                            </td>
                                            </tr>
                                        @endforeach
                                    @endif
