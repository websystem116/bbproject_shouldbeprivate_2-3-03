		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					@endif
					<form method="POST" action="{{route('before_juku_sales.store',['before_student_no' => $before_student->before_student_no,'school_building_id' => $before_student->school_building_id])}}" class="form-horizontal">
						{{ csrf_field() }}
						<div class="container">
							<div class="row">
								<div class="col-md-2">
									<label>生徒No：{{ $before_student->before_student_no}}</label>
								</div>
								<div class="col-md-2">
						...
						<table class="table table-striped table-hover table-bordered table-condensed table_sticky">
							...
							<tbody id="sales_table_tbody">
								...
								<tr>
									...
									<td class="col-md-2">
										{{Form::text('sales_date[]', $beforejukusale['sales_date'] ?? "", ['class' => 'form-control sales_date','id' => 'sales_date','placeholder' => '例：202005'])}}
									</td>
									<td class="col-md-1">
										{{Form::date('payment_date[]', false, ['class' => 'form-control payment_date','id' => 'payment_date'])}}
									</td>
									<td class="col-md-3">
										{{ Form::select('product_id[]',$products_select_list,false,['placeholder' => '選択してください', 'class' => 'form-control select_search product_id ']) }}
									</td>
									<td class="col-md-3">
								...
								<tr>
									...
									<td class="col-md-3 select_col">
										{{ Form::select('product_id[]',$products_select_list,$beforejukusale['product_id'],['placeholder' => '選択してください', 'class' => 'form-control product_id select_search']) }}
									</td>
									<td class="col-md-3">
