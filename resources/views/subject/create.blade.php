	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">成績カテゴリー新規登録</div>
				<div class="panel-body">
					<a href="{{ url('/shinzemi/result_category') }}" title="Back">
						<button class="btn btn-warning btn-xs">戻る</button></a>
					<br />
					<br />
					<form method="POST" action="{{route('result_category.store')}}" class="form-horizontal">
						{{ csrf_field() }}
						<div class="form-group">
							<label for="name" class="col-md-2">成績カテゴリー名: </label>
							<div class="col-md-6">
								{{Form::text('result_category_name', false, ['class' => 'form-control','id' => 'result_category_name','placeholder' => '成績カテゴリーネーム'])}}
							</div>
							<div class="custom-control custom-switch">
								{{Form::hidden('average_point_flg', '0') }}
								{{Form::checkbox('average_point_flg', '1',false, ['class'=>'custom-control-input','id'=>'average_point_flg'])}}
								{{Form::label('average_point_flg','学校平均点表示')}}
							</div>
						</div>
						...
						<table class="table table-striped table-hover table-bordered table-condensed table_sticky">
							...
							<tbody id="implementation_table_tbody">
								<tr>
									<td class="col-md-1 text-center implementation_No">
										{{Form::label('implementation_No','1')}}
									</td>
									<td class="col-md-1">
						...
						<div class="form-group">
							<div class="col-md-4">
								{{Form::submit('登録', ['name' => 'registration','class'=>'btn btn-primary btn-lg'])}}
							</div>
						</div>
					</form>
				</div>
