				...
				<div class="panel-body">
					...
					<form method="POST" action="{{route('student.store')}}" class="form-horizontal">
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								{{ Form::select('bank_id', $banks_select_list,null,['class' => 'form-control select_search_school','placeholder' => '選択してください']) }}
							</div>
							<div class="col-md-2 mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								{{ Form::select('branch_code', $branch_banks_select_list,null,['class' => 'form-control select_search','placeholder' => '選択してください']) }}
							</div>
							<div class="col-md-2 mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-md-4 mr-0 pr-0">
								{{ Form::select('lessons_id', $highschoolcourses_select_list,null,['placeholder' => '選択してください','class' => 'form-control select_search']) }}
							</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								{{Form::text('juku_history_date', null, ['class' => 'form-control','id' => 'juku_history_date'])}}
							</div>
						</div>
						<!--/塾内情報-->
