	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">入塾前生徒情報編集 名前：{{ $before_student->surname }}{{ $before_student->name }}</div>
				<div class="panel-body">
					...
					@endif
					{{ Form::model($before_student, array('route' => array('before_student.update', $before_student->id), 'method' => 'PUT', 'class' => 'form-horizontal')) }}
					...
					<div class="form-group row">
						...
						<div class="custom-control custom-checkbox custom-control-inline col-md-3">
							...
							{{Form::checkbox('brothers_flg', '1',$before_student->brothers_flg, ['class'=>'custom-control-input','id'=>'brothers_flg'])}}
							{{Form::label('brothers_flg','兄弟姉妹が在塾',['class'=>'custom-control-label'])}}
						</div>
						<div class="custom-control custom-checkbox custom-control-inline col-md-3">
							{{Form::hidden('fatherless_flg', '0') }}
							{{Form::checkbox('fatherless_flg', '1',$before_student->fatherless_flg, ['class'=>'custom-control-input','id'=>'fatherless_flg'])}}
					...
					<div class="form-group row">
						<div class="col-md-2 mb-3">
							{{Form::label('contact_tel_date','問合わせ管理')}}
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-2 mb-2">
					...
					<div class="form-group row">
						...
						<div class="custom-control custom-checkbox custom-control-inline col-md-3">
							...
							{{Form::checkbox('sign_up_juku_flg', '1',$before_student->sign_up_juku_flg, ['class'=>'custom-control-input','id'=>'sign_up_juku_flg'])}}
							{{Form::label('sign_up_juku_flg','入塾フラグ',['class'=>'custom-control-label'])}}
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-2 mb-4">
							{{Form::label('created_at','登録年月')}}
						</div>
						<div class="col-md-3">
							{{Form::text('created_at', $before_student->created_at, ['class' => 'form-control','id' => 'created_at','readonly'=>'readonly'])}}
						</div>
					</div>
					<!--ボタンブロック-->
					<div class="form-group row">
						<div class="col-md-4">
							{{Form::hidden('before_student_no', $before_student->before_student_no) }}
