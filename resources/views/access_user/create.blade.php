	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">入退室生徒新規登録</div>
				<div class="panel-body">
					...
					@endif
					<form method="POST" action="{{route('access_user.store')}}" class="form-horizontal">
						{{ csrf_field() }}
						...
						<div class="form-group row">
							...
							<div class="col-md-10">
							{{Form::email('email_access', null, ['autocomplete'=>'off','class' => 'form-control','id' => 'email','style'=>'background-color:#f3d7dc','placeholder' => 'メールアドレス（自動送信用）'])}}
						</div>
						</div>
						<div class="form-group row">
							<div class="col-md-2">
							...
							<div class="col-md-10">
								{{Form::email('email_access2', null, ['autocomplete'=>'off','class' => 'form-control','id' => 'email','placeholder' => 'メールアドレス（自動送信用）'])}}
							</div>
						</div>
