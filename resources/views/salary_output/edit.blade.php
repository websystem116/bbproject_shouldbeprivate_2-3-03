                                ...
                                <tbody class='performance_tr'>
                                    ...
                                    @else
                                        ...
                                        @foreach ($daily_salaries as $index => $value)
                                            ...
                                            <td>
                                                {{ Form::select('school_building[]', $school_buildings, $value->school_building_id, ['placeholder' => '選択してください', 'class' => 'form-control  school_building']) }}
                                            </td>
                                            <td>
                                                {{ Form::select('job_description[]', $job_descriptions, $value->job_description_id, ['placeholder' => '選択してください', 'class' => 'form-control  job_description']) }}
                                            </td>
                                            <td>
                                                {{ Form::number('working_time[]', $value->working_time, ['class' => 'form-control  working_time']) }}

                                            </td>
                                            <td>
                                                {{ Form::textarea('remarks[]', $value->remarks ?? '', ['class' => 'form-control remarks', 'placeholder' => '備考', 'rows' => '1']) }}
                                            </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                ...
                                <tbody class='tranceportation_tr'>
                                    @if ($transportation_expenses->count() == 0)
                                        ...
                                        <tr class='tranceportation_row'>
                                            <td>
                                                {{ Form::checkbox('tranceportation_select_flg[]', '1', false, ['class' => 'form-control checkbox_size custom-control-input tranceportation_select_flg']) }}
                                            </td>
                                            <td>
                                                {{ Form::select('tranceportation_school_building[]', $school_buildings, false, ['placeholder' => '選択してください', 'class' => 'form-control  form_text  tranceportation_school_building']) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_route[]', null, ['class' => 'form-control form_text tranceportation_route']) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_boarding_station[]', null, ['class' => 'form-control  form_text tranceportation_boarding_station']) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_get_off_station[]', null, ['class' => 'form-control  form_text tranceportation_get_off_station']) }}

                                            </td>
                                            <td>
                                                {{ Form::number('tranceportation_unit_price[]', null, ['class' => 'form-control form_price  tranceportation_unit_price', 'max' => '100000', 'min' => '0']) }}

                                            </td>
                                            <td>
                                                {{ Form::checkbox('tranceportation_round_trip_flg[]', 1, false, ['class' => 'form-control checkbox_size  tranceportation_round_trip_flg']) }}

                                            </td>
                                            <td>
                                                {{ Form::number('tranceportation_fare[]', null, ['class' => 'form-control form_price  tranceportation_fare']) }}
                                            </td>
                                            <td>
                                                {{ Form::textarea('tranceportation_remarks[]', null, ['class' => 'form-control  form_text tranceportation_remarks', 'placeholder' => '備考', 'rows' => '1']) }}
                                            </td>
                                        </tr>
                                    @else
                                        ...
                                        @foreach ($transportation_expenses as $index => $value)
                                            ...
                                            <td>
                                                {{ Form::select('tranceportation_school_building[]', $school_buildings, $value->school_building, ['placeholder' => '選択してください', 'class' => 'form-control  form_text  tranceportation_school_building']) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_route[]', $value->route, ['class' => 'form-control form_text tranceportation_route']) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_boarding_station[]', $value->boarding_station, ['class' => 'form-control  form_text tranceportation_boarding_station']) }}
                                            </td>
                                            <td>
                                                {{ Form::text('tranceportation_get_off_station[]', $value->get_off_station, ['class' => 'form-control  form_text tranceportation_get_off_station']) }}

                                            </td>
                                            <td>
                                                {{ Form::number('tranceportation_unit_price[]', $value->unit_price, ['class' => 'form-control form_price  tranceportation_unit_price', 'max' => '100000', 'min' => '0']) }}

                                            </td>
                                            <td>
                                                {{ Form::checkbox('tranceportation_round_trip_flg[]', 1, $value->round_trip_flg, ['class' => 'form-control checkbox_size  tranceportation_round_trip_flg']) }}

                                            </td>
                                            <td>
                                                {{ Form::number('tranceportation_fare[]', $value->fare, ['class' => 'form-control form_price  tranceportation_fare']) }}
                                            </td>
                                            <td>
                                                {{ Form::textarea('tranceportation_remarks[]', $value->remarks ?? '', ['class' => 'form-control  form_text tranceportation_remarks', 'placeholder' => '備考', 'rows' => '1']) }}
                                            </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                ...
                                <tbody>
                                    ...
                                    @else
                                        ...
                                        @foreach ($daily_other_salaries as $index => $value)
                                            ...
                                            <td>
                                                {{ Form::select('other_school_building[]', $school_buildings, $value->school_building, ['placeholder' => '選択してください', 'class' => 'form-control  school_building']) }}
                                            </td>
                                            <td>
                                                {{ Form::select('other_job_description[]', $other_job_descriptions, $value->job_description, ['placeholder' => '選択してください', 'class' => 'form-control  job_description']) }}
                                            </td>
                                            <td>
                                                {{ Form::textarea('other_remarks[]', $value->remarks ?? '', ['class' => 'form-control ', 'id' => 'remarks', 'placeholder' => '備考', 'rows' => '1']) }}
                                            </td>
                                            </tr>
                                        @endforeach
                                    @endif
